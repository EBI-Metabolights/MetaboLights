// This file was autogenerated by /home/epu/metabolomes/trunk/specview/src/main/javascript/specview/third-party/closure/closure/bin/build/depswriter.py.
// Please do not edit.
goog.addDependency('../../../../specview/controller/command.js', ['specview.controller.Command'], []);
goog.addDependency('../../../../specview/controller/controller.js', ['specview.controller.Controller', 'specview.controller.Controller.EventType'], ['goog.async.Delay', 'goog.debug.Console', 'goog.editor.BrowserFeature', 'goog.events', 'goog.graphics', 'goog.ui.KeyboardShortcutHandler', 'goog.ui.Prompt', 'specview.controller.Plugin', 'specview.model.NMRdata', 'specview.model.NeighborList', 'specview.view.MoleculeRenderer', 'specview.view.SpectrumRenderer']);
...
goog.addDependency('../../../../specview/io/spectrumcmlparserIE.js', ['specview.io.SpectrumCMLParserIE'], ['goog.debug.Logger', 'goog.dom.xml', 'specview.model.Atom', 'specview.model.Bond', 'specview.model.Molecule', 'specview.model.NMRdata', 'specview.model.Peak', 'specview.model.Spectrum', 'specview.util.Utilities']);
...
goog.addDependency('../../../../specview/model/nmrdata.js', ['specview.model.NMRdata'], ['goog.debug.Logger', 'specview.model.Molecule', 'specview.model.Spectrum', 'specview.view.SpectrumRenderer']);
...
goog.addDependency('../../../../specview/view/molecule_renderer.js', ['specview.view.MoleculeRenderer'], ['specview.graphics.ElementArray', 'specview.view.AromaticityRenderer', 'specview.view.AtomRenderer', 'specview.view.BondRenderer', 'specview.view.BondRendererFactory']);
