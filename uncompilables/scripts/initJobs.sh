...
bsub -q production-rh74 -u metabolights-dev /net/isilonP/public/rw/homes/tc_cm01/metabolights/scripts/maintainPublicV3_postgres.sh
bsub -q production-rh74 -u metabolights-dev /net/isilonP/public/rw/homes/tc_cm01/metabolights/scripts/unichem_postgres.sh
bsub -q production-rh74 -u metabolights-dev -R "rusage[mem=32000]" -M 32000 -n 8 /net/isilonP/public/rw/homes/tc_cm01/metabolights/scripts/export.sh
