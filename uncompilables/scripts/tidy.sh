...
find /nfs/www-prod/web_hx2/cm/metabolights/prod/zip_ondemand/ -name "*.zip" -mtime +20 -exec rm {} \; 2>&1 >/dev/null
find /nfs/metabolights/cheminf/prod/zip_ondemand/ -name "*.zip" -mtime +20 -exec rm {} \; 2>&1 >/dev/null
find /nfs/www-prod/web_hx2/cm/metabolights/prod/zip_ondemand/ -name "MTBLS*_*_*.zip" -mtime +1 -exec rm {} \; 2>&1 >/dev/null
find /nfs/metabolights/cheminf/prod/zip_ondemand/ -name "MTBLS*_*_*.zip" -mtime +1 -exec rm {} \; 2>&1 >/dev/null
