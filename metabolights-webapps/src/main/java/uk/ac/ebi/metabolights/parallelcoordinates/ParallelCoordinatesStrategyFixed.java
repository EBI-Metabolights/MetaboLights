...
public class ParallelCoordinatesStrategyFixed implements ParallelCoordinatesStrategy{
	...
	public ParallelCoordinatesDataSet Proccess(AssayGroup ag, Study study) {
		...
		ParallelCoordinatesDimension unit = new ParallelCoordinatesDimension("cF", "control - Female", "");
		ds.units.add(unit);
		
		unit = new ParallelCoordinatesDimension("cM", "control - Male", "");
		ds.units.add(unit);
		
		unit = new ParallelCoordinatesDimension("TF", "T2DM - Female", "");
		ds.units.add(unit);

		unit = new ParallelCoordinatesDimension("TM", "T2DM - Male", "");
		ds.units.add(unit);
