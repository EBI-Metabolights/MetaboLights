...
// module
exports.push([module.i, ".btn-transparent {\n  background-color: transparent;\n  font-size:18px;\n  padding:0px;\n}\n\na {color:green;}\n", ""]);
...
var AppComponent = (function () {
    function AppComponent(http, fb) {
        ...
        this.orcidDevSearchURL = "https://www.ebi.ac.uk/ebisearch/ws/rest/europepmc?query=ORCID:";
        this.orcidSearchFormat = "&format=json";
        this.pmidDevSearchURL = "https://www.ebi.ac.uk/ebisearch/ws/rest/europepmc/entry/";
        this.pmidSearchFormat = "/xref/metabolights?format=json";
        this.batchClaimURL = "http://wwwdev.ebi.ac.uk/ebisearch/search.ebi?db=metabolights&query=domain_source:metabolights";
        this.mtblsISAEndpoint = "http://ves-ebi-90:5000/mtbls/ws/study/";
    ...
    AppComponent.prototype.searchForPMIDS = function (pmids) {
        var _this = this;
        ...
        this.getSimpleRequest(ebiPMIDsearchQuery)
            ...
            console.log(response);
            if (response.length != 0) {
                _this.extractMtblsIDs(response);
            }
            else {
                _this.resolved = true;
            }
...
var MtblsEntryComponent = (function () {
    ...
    MtblsEntryComponent.prototype.getTitle = function (studyID) {
        var _this = this;
        var fetchTitleUrl = "http://wwwdev.ebi.ac.uk/ebisearch/ws/rest/metabolights?query=id:" + studyID + "&fields=id,name&format=json";
    ...
    MtblsEntryComponent.prototype.getDescription = function (studyID) {
        var _this = this;
        var fetchTitleUrl = "http://wwwdev.ebi.ac.uk/ebisearch/ws/rest/metabolights?query=id:" + studyID + "&fields=id,description&format=json";
        this.getSimpleRequest(fetchTitleUrl).subscribe(function (response) {
            if (response['hitCount'] == 1) {
                var entries = response["entries"];
                for (var i in entries) {
