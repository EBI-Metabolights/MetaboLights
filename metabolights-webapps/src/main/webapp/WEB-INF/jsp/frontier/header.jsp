<%@taglib prefix="sec" uri="http://www.springframework.org/security/tags" %>
    <%@taglib uri="http://www.springframework.org/tags" prefix="spring" %>
        <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            <%-- ~ EBI MetaboLights - http://www.ebi.ac.uk/metabolights ~ Cheminformatics and Metabolism group ~ ~
                European Bioinformatics Institute (EMBL-EBI), European Molecular Biology Laboratory, Wellcome Trust
                Genome Campus, Hinxton, Cambridge CB10 1SD, United Kingdom ~ ~ Last modified: 11/1/12 10:09 AM ~
                Modified by: conesa ~ ~ ~ ©, EMBL, European Bioinformatics Institute, 2014. ~ ~ Licensed under the
                        ...
                        <nav class="navbar navbar-inverse" style="z-index: 10000">
                            <div class="container">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="//www.ebi.ac.uk"><i class="icon icon-generic" data-icon="H"></i>
                                            EMBL-EBI</a></li>
                                </ul>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-large row dark">
                                            <div class="col-md-9">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="row">
                                                            <p>EMBL-EBI in Hinxton is one of six EMBL locations across
                                                                europe.</p>
                                                            <a href="//www.ebi.ac.uk/about"
                                                                class="small readmore np">More about EMBL-EBI</a>
                                                    ...
                                                    <div class="col-md-7 np">
                                                        <div class="columns small-7 padding-bottom-medium">
                                                            <a class="np"
                                                                href="http://www.embl-barcelona.es/">Barcelona</a>
                                                            <div class="small">Tissue biology and disease <br> modelling
                                                            </div>
                                                        </div>
                                                        <div class="columns small-7 padding-bottom-medium">
                                                        ...
                                                        <div class="columns small-7 padding-bottom-medium">
                                                            <a class="np readmore" href="http://embl.org/"
                                                                class="readmore">More about EMBL</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <a href="//www.ebi.ac.uk">
                                    <img class="ebi-logo"
                                        src="//www.ebi.ac.uk/web_guidelines/EBI-Framework/v1.2/images/logos/EMBL-EBI/EMBL_EBI_Logo_white.svg">
                                </a>
                                <span class="pull-right">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="research"><a href="//www.ebi.ac.uk/research"><span
                                                    class="clearfix">Research</span></a></li>
                                        <li class="training"><a href="//www.ebi.ac.uk/training"><span
                                                    class="clearfix">Training</span></a></li>
                                        <li class="about"><a href="//www.ebi.ac.uk/about"><span class="clearfix">About
                                                    us</span></a></li>
                                    </ul>
                                </span>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <c:if test="${not empty bannerMessage}">
                                            <div class="col-md-12 ">
                                                <div
                                                    style="font-size: 14px; color: red; background-color: cornsilk; border-radius: 5px; padding: 5px; border: 1px solid #cce9ff; ">
                                                    ${bannerMessage}</div>
                                            </div>
                                        </c:if>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-7 col-sm-6">
                                            <div class="alpha logo-title" id="local-title">
                                                <a id="mlLogo" class="ml-logo" href="index"
                                                    title="Back to MetaboLights homepage">
                                                    <img src="${pageContext.request.contextPath}/img/MetaboLightsLogo.png"
                                                        alt="MetaboLights" width="64" height="64" />MetaboLights
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <form id="local-search" name="local-search"
                                                ...
                                                <small class="hidden-xs">
                                                    <span class="examples">Examples: <a
                                                            href="${pageContext.request.contextPath}/search?freeTextQuery=alanine">Alanine</a>,
                                                        <a
                                                            href="${pageContext.request.contextPath}/search?freeTextQuery=Homo sapiens">Homo
                                                            sapiens</a>, <a
                                                            href="${pageContext.request.contextPath}/search?freeTextQuery=urine">Urine</a>,
                                                        <a
                                                            href="${pageContext.request.contextPath}/search?freeTextQuery=MTBLS1">MTBLS1</a>
                                                        <%--<br><a
                                                                href="${pageContext.request.contextPath}/advancedsearch"
                                                                target="_blank">Advanced Search</a></span>--%>
                                                </small>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                        <span class="hidden-sm hidden-md">
                                            <ul class="nav navbar-nav cnav">
                                                ...
                                                <li><a href="${pageContext.request.contextPath}/studies">Browse
                                                        Studies</a></li>
                                                <li><a href="${pageContext.request.contextPath}/compounds">Browse
                                                        Compounds</a></li>
                                                <li><a href="${pageContext.request.contextPath}/species">Browse
                                                        Species</a></li>
                                                <%--<li><a
                                                        href="${pageContext.request.contextPath}/analysis">Analysis</a>
                                                    </li>--%>
                                                    <li><a
                                                            href="${pageContext.request.contextPath}/download">Download</a>
                                                    </li>
                                                    <li><a href="${pageContext.request.contextPath}/guides"
                                                            target="_blank">Help</a></li>
                                                    <li><a href="${pageContext.request.contextPath}/contact">Give us
                                                            feedback</a></li>
                                                    <li><a href="${pageContext.request.contextPath}/about">About</a>
                                                    </li>
                                                    <li><a href="${pageContext.request.contextPath}/editor/datapolicy">Data
                                                            Policy</a></li>
                                                    <li><a
                                                            href="${pageContext.request.contextPath}/training">Training</a>
                                                    </li>
                                            </ul>
                                        ...
                                        <span class="hidden-xs hidden-lg">
                                            <ul class="nav navbar-nav cnav">
                                                ...
                                                <li><a href="${pageContext.request.contextPath}/download">Download</a>
                                                </li>
                                                <li><a href="${pageContext.request.contextPath}/guides"
                                                        target="_blank">Help</a></li>
                                                <li><a href="${pageContext.request.contextPath}/contact">Give us
                                                ...
                                                <li><a href="${pageContext.request.contextPath}/editor/datapolicy">Data
                                                        Policy</a></li>
                                                <li><a href="${pageContext.request.contextPath}/training">Training</a>
                                                </li>
                                            </ul>
                                            </li>
                                            </ul>
