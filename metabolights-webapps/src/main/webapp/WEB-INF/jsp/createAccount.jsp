				...
				<div class="ml-loginpanelbody">
					<div class="">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="checkbox-inline"><input type="checkbox" id="privacyPolicy"/><small> I agree to EMBL-EBI MetaboLights cookie policy and the limited processing of my personal data as outlined in <a target="_blank" href="assets/dpe/Metabolights-privacy-notice-v1.pdf">Privacy Notice</a>.</small></label><br>
