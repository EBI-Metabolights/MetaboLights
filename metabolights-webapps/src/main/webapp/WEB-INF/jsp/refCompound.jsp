...
<div id="content" class="grid_24">
    ...
    <div class="grid_6 alpha">
        ...
        <div class="grid_24">
            ...
            <p><a href="${pageContext.request.contextPath}/referencespectraupload?cid=${compound.mc.accession}" class="icon icon-functional" data-icon="_">Upload Reference Spectra</a></p>
        </div>
        ...
        <div id="tabs" class="tabContainer">
            <ul class="tabHeader">
                ...
                <c:if test="${compound.mc.hasReactions}">
                    <li hash="reactions">
                        <a class="noLine" href="${pageContext.request.contextPath}/reactions?compoundId=${compound.mc.accession}"><spring:message
                ...
                <c:if test="${compound.mc.hasLiterature}">
                    <li hash="literature">
                        <a class="noLine" href="${pageContext.request.contextPath}/citations?compoundId=${compound.mc.accession}"><spring:message
