...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="panel nbr panel-warning">
            ...
            <div class="panel-body">
                All data is governed by the EMBL-EBI's <a href="http://www.ebi.ac.uk/about/terms-of-use" target="_blank">Terms of use</a> and aligned to EMBL-EBI’s <a href="https://www.ebi.ac.uk/long-term-data-preservation" target="_blank">Long-term data preservation</a>. <br> 
                All <a href="https://github.com/EBI-Metabolights" target="_blank">code</a> is licensed under <a href="http://www.apache.org/licenses/LICENSE-2.0" target="_blank">Apache 2.0</a>.
            </div>
        </div>
    </div>
</div>
