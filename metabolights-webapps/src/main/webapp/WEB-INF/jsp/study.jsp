            ...
            <div class="col-md-4">
                <p>
                    <span class="pull-right">
                        ...
                        <c:if test="${userHasEditRights eq true && study.studyStatus.descriptiveName eq 'Submitted'}"> &nbsp;<i class="fa fa-pencil"></i><a id="redirectToEditorPage" style="cursor: pointer">&nbsp;Quick edit</a> </c:if>
