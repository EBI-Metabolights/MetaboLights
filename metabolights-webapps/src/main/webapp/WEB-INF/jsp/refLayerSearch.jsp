                    ...
                    <span id="pagination" class="right">
                        ...
                        <%--Below code is to make it look like '1 2 3 4 5 .... 561'.--%>
                            <c:if test="${(rffl.totalNumOfPages lt 5)}">
                                ...
                                <c:forEach var="iterator" begin="2" end="${rffl.totalNumOfPages - 1}" step="1" varStatus="loopStatus">
                                    <c:if test="${iterator eq rffl.currentPage}">
                                        <b>${rffl.currentPage}</b>
                                    </c:if>

                                    <c:if test="${iterator ne rffl.currentPage}">
                                        <a href="#" style="text-decoration: none"> <span style="font-weight: normal" onClick="navigate(${iterator})"><c:out value="${iterator}" /></span></a>
                                    </c:if>
                                </c:forEach>
                           ...
                           <c:if test="${rffl.totalNumOfPages gt 5}">
                               ...
                               <c:if test="${(rffl.currentPage lt 5)}">
                                   ...
                                   <c:forEach var="iterator" begin="2" end="5" step="1" varStatus="loopStatus">
                               ...
                               <c:if test="${(((rffl.currentPage eq 5) || (rffl.currentPage gt 5)) && ((rffl.currentPage lt (rffl.totalNumOfPages - 5)) || (rffl.currentPage eq (rffl.totalNumOfPages - 5))))}">
                               ...
                               <c:if test="${((rffl.currentPage gt (rffl.totalNumOfPages - 5)))}">

                                   .....

                                   <c:forEach var="iterator" begin="${rffl.totalNumOfPages - 5}" end="${rffl.totalNumOfPages - 1}" step="1" varStatus="loopStatus">
                                       <c:if test="${iterator eq rffl.currentPage}">
                                           <b>${rffl.currentPage}</b>
                                       </c:if>
