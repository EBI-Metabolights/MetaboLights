...
LabsURL['studiesList'] = server + 'study/list';
// Workspace
            ...
            this.http.post(this.selectedGalaxyInstance.url + "api/tools?key=" + this.selectedGalaxyInstance.apikey, body)
                ...
                if (error.status == 0) {
                    _this.alerts.push({
                        id: 1,
                        type: 'success',
                        message: 'Files exported to galaxy successfully <a target="_blank" href="' + _this.selectedGalaxyInstance.url + 'history/view_multiple">view in galaxy</a',
                    });
                }
                _this.exportToGalaxyModalRef.close();
                _this.selectedFiles = [];
