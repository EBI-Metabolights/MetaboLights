...
(AW4.__VERSION__ = "3.9.9.177872"),
  ...
  (AW4.ConnectInstaller = function (a) {
    ...
    var b = AW4.ConnectInstaller.EVENT,
      ...
      m = 0;
    u(a) && (a = {}),
      u(AW4.Utils.getLocalStorage("aspera-install-attempted")) &&
        AW4.Utils.setLocalStorage("aspera-install-attempted", "true"),
      u(AW4.Utils.getLocalStorage("aspera-last-detected")) &&
        AW4.Utils.setLocalStorage("aspera-last-detected", ""),
      (f.iframeId = a.iframeId || "aspera-iframe-container"),
      (f.oneClick = a.oneClick === !1 ? !1 : !0),
      (f.useFips = a.useFips === !0 ? !0 : !1),
      (f.sdkLocation = u(a.sdkLocation)
        ? d
    ...
    var o = function (a, b, c) {
        ...
        d = a.length;
        for (var g = 0; g < d; g++) typeof a[g] == "string" && f(a[g]);
      },
      p = function () {
        var a = "Not supported";
        /Win/.test(navigator.platform)
          ? navigator.userAgent.indexOf("WOW64") != -1 ||
            ...
            ? (a = "Win64")
            : (a = "Win32")
          : /Mac OS X 10[._]6/.test(navigator.userAgent)
          ? (a = "MacIntel-10.6-legacy")
          : /Mac/.test(navigator.platform)
          ? (a = "MacIntel")
          : /Linux x86_64/.test(navigator.platform)
          ? (a = "Linux x86_64")
          : /Linux/.test(navigator.platform) && (a = "Linux i686");
        return a;
      },
      q = function () {
        var a = "";
        /Win/.test(navigator.platform)
          ? (a = navigator.userAgent.match(/Windows NT (\d+)[._](\d+)/))
          : /Mac/.test(navigator.platform) &&
            (a = navigator.userAgent.match(/OS X (\d+)[._](\d+)/));
        if (u(a)) return null;
        var b = {
          ...
          g = function (b) {
            ...
            for (var i = 0; i < e.length; i++) {
              ...
              if (j.navigator.platform === g) {
                ...
                if (
                  k.highWord > l.highWord ||
                  (k.highWord >= l.highWord && k.loWord >= l.loWord)
                ) {
                  f(j);
                  return null;
                }
      ...
      y = function (a, b) {
        ...
        AW4.Utils.BROWSER.SAFARI_NO_NPAPI &&
          (c = new AW4.SafariAppExtRequestImplementation());
        c.isSupportedByBrowser()
          ? c.detectExtension(a, b)
          : AW4.Logger.log("This browser does not use extensions.");
      },
      z = function () {
        if (
          AW4.Utils.BROWSER.CHROME === !0 ||
          AW4.Utils.BROWSER.FIREFOX === !0 ||
          AW4.Utils.BROWSER.EDGE_WITH_EXTENSION === !0
        )
          return !0;
        return !1;
      },
      ...
      E = function (a) {
        for (var b in c) if (c[b] == a) return !0;
        return !1;
      },
      F = function (a) {
        for (var b = 0; b < l.length; b++) l[b](a);
      },
      G = function (a) {
        function g() {
          (j = !0), s(b.IFRAME_LOADED);
          ...
          if (AW4.Utils.BROWSER.SAFARI || AW4.Utils.BROWSER.IE) {
            ...
            AW4.Utils.isNullOrUndefinedOrEmpty(d) ||
              c.contentWindow.postMessage("downloadTimestamp=" + d, "*");
          }
          var e = function (b) {
              ...
              f.useFips && (g = g + "-fips"),
                e.rel === g &&
                  ...
                  (c.contentWindow.postMessage(
                    "downloadlink=" + e.hrefAbsolute,
                    "*"
                  ),
                  c.contentWindow.postMessage(
                    "downloadVersion=" + b.version,
                    "*"
                  ));
            }
          ...
          x(e),
            f.stylesheetLocation &&
              typeof c != "undefined" &&
              c !== null &&
              c.contentWindow.postMessage(
                "insertstylesheet=" + f.stylesheetLocation,
                "*"
              ),
            f.correlationId &&
              c.contentWindow.postMessage(
            ...
            AW4.__VERSION__ &&
              c.contentWindow.postMessage("sdkVersion=" + AW4.__VERSION__, "*"),
            s(b.IFRAME_LOADED);
        }
        function e(a) {
          E(a.data) &&
            (AW4.Logger.debug("Connect bar activity: " + a.data),
            F(a.data),
            a.data === c.CLICKED_DOWNLOAD_APP
              ? AW4.Utils.setLocalStorage(
                  "aspera-connect-app-download",
                  Date.now()
                )
              : a.data === c.CLICKED_INSTALL_APP
              ? (AW4.Utils.BROWSER.SAFARI || AW4.Utils.BROWSER.IE) && O()
              : a.data === c.CLICKED_RETRY && D());
          if (a.data === b.DOWNLOAD_CONNECT) s(a.data), L();
          else if (a.data === b.DOWNLOAD_EXTENSION) s(a.data), K();
          else if (a.data === b.REFRESH_PAGE) {
            s(a.data);
            var e = C();
            e.location.reload(!0);
          } else if (a.data === b.IFRAME_REMOVED) s(a.data), S();
          else if (a.data === b.TROUBLESHOOT) {
            s(a.data);
            var e = C();
            e.location = "https://test-connect.asperasoft.com";
          } else if (a.data === b.CONTINUE) {
            AW4.Utils.addVersionException(), s(a.data);
            if (
              (AW4.Utils.BROWSER.SAFARI &&
                !AW4.Utils.BROWSER.SAFARI_NO_NPAPI) ||
            ...
            a.data === b.RETRY
              ...
              ? d.setAttribute(
                  "style",
                  "height:100%;width:100%;max-width: 100%;margin: 0 auto;background-color:rgba(223, 227, 230, 0.75);"
                )
              : typeof a.data == "string" && a.data.endsWith(b.RESIZE)
              ? ((d.style.height = a.data), (d.style.maxWidth = "600px"))
              : a.data === b.EXTENSION_INSTALL && (s(a.data), B());
        }
        i !== 0 && clearTimeout(i);
        ...
        if (!d) {
          f.style == "carbon"
            ? t(
                "." +
                  f.iframeId +
                  "{width: 100%;max-width: 600px;height: 80px;margin: 0 auto;position: fixed;top: 0;right: 0;left: 0;z-index: 9999;box-shadow: 0 12px 24px 0 rgba(0, 0, 0, 0.1)}"
              )
            : f.style == "blue" &&
              t(
                "." +
                  f.iframeId +
                  "{position: absolute;width: 100%;height: 80px;margin: 0px;padding: 0px;border: none;outline: none;overflow: hidden;top: 0px;left: 0px;z-index: 999999999}"
              );
          ...
          if (!d.contentWindow.postMessage) return;
          window.attachEvent
    ...
    window.addEventListener(
      "message",
      function (a) {
        a.data === "show_extension_install"
          ? O()
          : a.data === "show_safari_mitigate" && G("safari_mitigate");
      },
      !1
    );
    var H = function (a) {
        (a = typeof a == "number" ? a : 3500), i !== 0 && clearTimeout(i);
        var b = function () {
          G("launching");
        };
        i = setTimeout(b, a);
      ...
      I = function () {
        if (
          AW4.MIN_REQUESTED_VERSION &&
          !AW4.Utils.versionLessThan(
            AW4.MIN_REQUESTED_VERSION,
            AW4.MIN_SECURE_VERSION
          )
        )
          return !1;
        return !0;
      ...
      J = function () {
        if (typeof AW4.connectVersion == "undefined") return !1;
        return AW4.Utils.versionLessThan(
          AW4.connectVersion,
          AW4.MIN_SECURE_VERSION
        );
      },
      ...
      R = function (a) {
        (a = typeof a == "number" ? a : 2e3), clearTimeout(i);
