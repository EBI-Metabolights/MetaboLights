 ...
 */
@Entity
@DiscriminatorValue("ContactRole")
public class ContactRole extends OntologyEntry {
	protected ContactRole() {
	}

	protected ContactRole(String name, ReferenceSource source) {
		super(name, source);
	}

	public ContactRole(String acc, String name, ReferenceSource source) {
