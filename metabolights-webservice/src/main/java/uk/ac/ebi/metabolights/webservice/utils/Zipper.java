...
public static void unzip (String strZipFile) throws IOException, ArchiveException {
	...
	public static File unzip2(String strZipFile) throws IOException, ArchiveException {

		String outPutFolder = FilenameUtils.removeExtension(strZipFile);

		unzip2(strZipFile, outPutFolder);
