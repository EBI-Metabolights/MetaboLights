...
public class ReaderTestCompoundDB extends TestCase{
	...
	static String[] expected = new String[]{null,"ACC1U","Updated compound", "Updated compound description", "Inchi value updated", "ChebiId updated"};
	...
	public void testSavingACompound() throws Exception {
		...
		String[] newCompound = new String[]{null,"ACC1","New compound", "New compound description", "New inchi value", "New chebiId"};
