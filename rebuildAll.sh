...
echo "    PROD"
echo ""
echo "    scp metabolights-webapps/target/metabolights-webapp-*.war ebi-003:/nfs/www-prod/web_hx2/cm/metabolights/deploy/metabolights-webapp-prod.war "
echo "    scp metabolights-webservice/target/metabolights-webservice-*.war ebi-003:/nfs/www-prod/web_hx2/cm/metabolights/deploy/metabolights-webservice-prod.war "
echo ""
echo "    DEV"
echo ""
echo "    scp metabolights-webapps/target/metabolights-webapp-*.war ebi-003:/nfs/www-prod/web_hx2/cm/metabolights/deploy/metabolights-webapp-dev.war "
echo "    scp metabolights-webservice/target/metabolights-webservice-*.war ebi-003:/nfs/www-prod/web_hx2/cm/metabolights/deploy/metabolights-webservice-dev.war "
echo ""
echo "    TEST"
echo ""
